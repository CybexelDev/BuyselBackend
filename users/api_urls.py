...
urlpatterns = [
    ...
    path("agents/reviews/submit/", SubmitAgentReviewAPIView.as_view(), name="agent-review-submit"),
    path("agents/<str:agent_id>/reviews/", AgentReviewListAPIView.as_view(), name="agent-review-list"),    # path('agent/register/', AgentRegisterAPIView.as_view(), name='agent-register'),
